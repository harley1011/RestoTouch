...
export class MenuListService {
  ...
  addRestaurantMenu (menuId: number, restaurantId: number): void {
    console.log('Add: ' + menuId + ' <---> ' + restaurantId);
  ...
  //deleteRestaurantMenu (menuId: number, restaurantId: number): Observable<Menu> {
  deleteRestaurantMenu (menuId: number, restaurantId: number): void {
    console.log('Remove: ' + menuId + ' <---> ' + restaurantId);
